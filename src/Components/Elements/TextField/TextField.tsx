...
const TextField = ({ classes="", icon=null, edge=null,options, placeholder="", label, type="text", name, onChange, isReadOnly=false, width100=false,value='' }: IProps): JSX.Element => {
